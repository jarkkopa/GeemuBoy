...
namespace GameBoy.GB
{
    public class CPU
    {
        ...
        private void CreateOpCodes()
        {
            ...
            CreateOpCode(0x46, () => CopyFromAddress(ref B, BitUtils.BytesToUshort(H, L)), "LD B, (HL)");
            ...
            CreateOpCode(0x4E, () => CopyFromAddress(ref C, BitUtils.BytesToUshort(H, L)), "LD C, (HL)");
            ...
            CreateOpCode(0x56, () => CopyFromAddress(ref D, BitUtils.BytesToUshort(H, L)), "LD D, (HL)");
            ...
            CreateOpCode(0x5E, () => CopyFromAddress(ref E, BitUtils.BytesToUshort(H, L)), "LD E, (HL)");
            ...
            CreateOpCode(0x66, () => CopyFromAddress(ref H, BitUtils.BytesToUshort(H, L)), "LD H, (HL)");
            ...
            CreateOpCode(0x6E, () => CopyFromAddress(ref L, BitUtils.BytesToUshort(H, L)), "LD L, (HL)");
            ...
            CreateOpCode(0x36, () => CopyImmediate8ToAddress(BitUtils.BytesToUshort(H, L)), "LD (HL), ");
        }
        ...
        public void CopyImmediate8ToAddress(ushort address)
        {
